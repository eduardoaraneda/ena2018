    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(usuario.equals("")&&password.equals("")){
                request.setAttribute("msg", "Completar ambos campos");
                RequestDispatcher rd = request.getRequestDispatcher("index.jsp");
                rd.forward(request, response);
            
            }
            if(usuario.equals("")){
                request.setAttribute("msg", "Ingresar Usuario");
                RequestDispatcher rd = request.getRequestDispatcher("index.jsp");
                rd.forward(request, response);
            ...
            if(password.equals("")){
                request.setAttribute("msg", "Ingresar Contraseña");
                RequestDispatcher rd = request.getRequestDispatcher("index.jsp");
                rd.forward(request, response);
            }
            
            if(!usuario.equals(usernamesql)||!password.equals(passwordsql)){
                request.setAttribute("msg", "Usuario o Password icorrectos");
                RequestDispatcher rd = request.getRequestDispatcher("index.jsp");
                rd.forward(request, response);                
            }
